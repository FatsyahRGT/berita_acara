...
<div class="mb-3" align="right">
    <a href="?pg=tambah-user-role&id_user=<?php echo urlencode($user_id) ?>" class="btn btn-primary">Tambah User Level</a>
</div>
            ...
            <tr>
                ...
                <td>
                    <a
                        ...
                        href="?pg=user-role&id_user=<?php echo $rowUser['id'] ?>"> User Level
                    </a>
                    <a
                        class="btn btn-success btn-xs"
